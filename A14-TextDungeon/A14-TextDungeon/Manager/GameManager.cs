...
namespace A14_TextDungeon
{
    public class GameManager
    {
        ...
        {
            new User("전사", 1 , User.UserJob.Warrior, 10 , 5, 500, 50 , 1500,1,  false),
            new User("도적", 1 , User.UserJob.Rogue, 15 , 3, 300, 70 , 1500,1, false)
        };
